...
<html>
	...
	<body>
		<a href="#list-dumpLoader" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-dumpLoader" class="content scaffold-list" role="main">
			...
			<div class="pagination">
				<g:paginate total="${dumpLoaderInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
