...
<html>
	...
	<body>
		<a href="#list-observableProcess" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-observableProcess" class="content scaffold-list" role="main">
			...
			<div class="pagination">
				<g:paginate total="${observableProcessInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
