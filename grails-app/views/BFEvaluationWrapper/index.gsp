...
<html>
	...
	<body>
		<a href="#list-BFEvaluationWrapper" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-BFEvaluationWrapper" class="content scaffold-list" role="main">
			...
			<div class="pagination">
				<g:paginate total="${BFEvaluationWrapperInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
